...
import dBankABI from "./contracts/dBank.json";
    ...
    if (window.ethereum !== "undefined") {
      ...
      try {
        ...
        const dBank = new web3.eth.Contract(
          dBankABI.abi,
          dBankABI.networks[netId].address
        );
        const dBankAddress = dBankABI.networks[netId].address;
        this.setState({
          token: token,
          dbank: dBank,
        ...
        window.alert("Contract isn't deployed to the current network");
      }
    } else {
  ...
  async payOff(e) {
    ...
    if (this.state.dbank !== null) {
      try {
        ...
        console.log("Error, payoff : ", error);
      }
    }
  }
